...
# Simple API key manager for Godot. Saves a small JSON file to `user://`.
# Note: for maximum security, prefer OS keyring integrations or encrypted
# storage; this helper is a pragmatic cross-platform default.
